...
class Model_NEMURO(BaseBGCModel):
    ...
    def _run_kernel(
        ...
        # Initialize Outputs
        PSn_n = np.zeros_like(nitrate)
        PLn_n = np.zeros_like(nitrate)
        ZSn_n = np.zeros_like(nitrate)
        ZLn_n = np.zeros_like(nitrate)
        ZPn_n = np.zeros_like(nitrate)
        nitrate_n = np.zeros_like(nitrate)
        ammonium_n = np.zeros_like(nitrate)
        PON_n = np.zeros_like(nitrate)
        DON_n = np.zeros_like(nitrate)
        PLsi_n = np.zeros_like(nitrate)
        ZLsi_n = np.zeros_like(nitrate)
